<template lang="html">
    ...
    <article v-else class='relative bg-gradient-blue-linear p-6 rounded-[10px] min-w-[335px] text-white-default text-center flex flex-col gap-4 items-center justify-center'>
        <p v-if="(story.user_name === 'Todd Dunning')" class='text-[26px] font-[700] z-[2] grow'>"{{ story.testimonial }}"</p>
        <p v-else-if="(story.user_name === 'Riley Venable')" class='text-[18px] font-[700] z-[2] grow'>"{{ story.testimonial }}"</p>
        <p v-else="(story.user_name === 'Jake Kring')" class='text-[20px] font-[700] z-[2] grow'>"{{ story.testimonial }}"</p>
