<template lang="html">
    <section class='bg-gradient-blue flex items-center justify-center max-w-full'>
        <div class='flex flex-col items-center gap-y-6 max-w-[1440px] py-8 md:py-14 px-4 md:px-28'>
